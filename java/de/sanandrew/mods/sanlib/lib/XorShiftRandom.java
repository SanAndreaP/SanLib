...
public final class XorShiftRandom
{
    ...
    /**
     * sets the new seed for this RNG instance. If {@code seed} is 0, the seed will be {@code 0xdeadbeef}.
    ...
    /**
     * Calculates a new randomized 64-bit double number within the range of 0.0 (included) to 1.0 (excluded)
    ...
    /**
     * Calculates a new randomized 32-bit float number within the range of 0.0 (included) to 1.0 (excluded)
    ...
    /**
     * Calculates a new randomized 64-bit gaussian number
