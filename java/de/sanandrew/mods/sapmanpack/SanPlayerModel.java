...
public class SanPlayerModel
{
    ...
    public static final String COMMON_PROXY = "de.sanandrew.mods.sapmanpack.CommonProxy";
    public static final String CLIENT_PROXY = "de.sanandrew.mods.sapmanpack.client.ClientProxy";
