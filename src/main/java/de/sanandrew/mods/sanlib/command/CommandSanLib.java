...
public class CommandSanLib
{
    ...
    private static int openEntityRender(CommandContext<CommandSource> c, boolean hasNbt, boolean hasColor, boolean hasTick) throws CommandSyntaxException {
        ...
        SanLib.NETWORK.sendToPlayer(new MessageEntityRender(rl, nbt, MiscUtils.get(tf.getColor(), 0xFF00FF) | 0xFF000000, tick), c.getSource().getPlayerOrException());
