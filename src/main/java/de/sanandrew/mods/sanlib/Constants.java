...
public class Constants
{
    ...
    static final String BUILD_FORGEVER = "1.12.2-14.23.5.2811";
    ...
    public static final String PM_VERSION             = "1.1.2";
    public static final String PM_ACCEPTED_REMOTE_VER = "[1.0.2,)";
